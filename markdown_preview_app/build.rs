...
fn generate_frontend_html() {
    ...
    // Source files from crates/maple_markdown/js
    let js_dir = base_path.join("crates/maple_markdown/js");
    let html_template =
...
"#;
    ...
    println!("cargo:rerun-if-changed=../crates/maple_markdown/js/index.html");
    println!("cargo:rerun-if-changed=../crates/maple_markdown/js/styles.css");
    println!("cargo:rerun-if-changed=../crates/maple_markdown/js/themes.css");
    println!("cargo:rerun-if-changed=../crates/maple_markdown/js/core.js");
    println!("cargo:rerun-if-changed=../crates/maple_markdown/js/tauri-app.js");
    println!("cargo:rerun-if-changed=../crates/maple_markdown/js/terminal.js");
    println!("cargo:rerun-if-changed=../crates/maple_markdown/js/pdf-viewer.js");
}
...
fn copy_vendor_files() {
    ...
    let source_vendor = base_path.join("crates/maple_markdown/js/vendor");
    ...
    println!("cargo:rerun-if-changed=../crates/maple_markdown/js/vendor");
}
