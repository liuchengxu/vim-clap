...
if s:using_dynamic_module
  ...
  function! clap#filter#sync#python#(query, candidates, winwidth, enable_icon, line_splitter) abort
  ...
  function! clap#filter#sync#python#(query, candidates, _winwidth, enable_icon, _line_splitter) abort
