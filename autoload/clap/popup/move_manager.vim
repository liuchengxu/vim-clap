...
let s:move_manager["\<Tab>"] = { winid -> win_execute(winid, 'noautocmd call clap#handler#handle_mapping_tab()') }
let s:move_manager["\<CR>"] = { _winid -> clap#handler#handle_mapping_cr() }
